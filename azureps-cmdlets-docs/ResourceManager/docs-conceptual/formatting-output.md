...
| <span data-ttu-id="59b47-106">Formatering</span><span class="sxs-lookup"><span data-stu-id="59b47-106">Formatting</span></span>      | <span data-ttu-id="59b47-107">Konvertering</span><span class="sxs-lookup"><span data-stu-id="59b47-107">Conversion</span></span>       |
|-----------------|------------------|
...
<span data-ttu-id="59b47-111">Om du vill begränsa de kolumner som returneras kan du använda cmdleten `Format-Table`.</span><span class="sxs-lookup"><span data-stu-id="59b47-111">If you would like to limit the columns returned you can use the `Format-Table` cmdlet.</span></span> <span data-ttu-id="59b47-112">I följande exempel har vi samma lista över virtuella datorer men begränsar utdata till endast den virtuella datorns namn, resursgrupp och den virtuella datorns plats.</span><span class="sxs-lookup"><span data-stu-id="59b47-112">In the following example we get the same list of virtual machines but restrict the output to just the name of the VM, the resource group, and the location of the VM.</span></span>  <span data-ttu-id="59b47-113">Parametern `-Autosize` ändrar storleken på kolumner enligt storleken på data.</span><span class="sxs-lookup"><span data-stu-id="59b47-113">The `-Autosize` parameter sizes the columns according to the size of the data.</span></span>
...
<span data-ttu-id="59b47-114">Om du så önskar kan du kan se information i ett listformat.</span><span class="sxs-lookup"><span data-stu-id="59b47-114">If you would prefer you can view information in a list format.</span></span> <span data-ttu-id="59b47-115">I följande exempel ser du detta med cmdleten `Format-List`.</span><span class="sxs-lookup"><span data-stu-id="59b47-115">The following example shows this using the`Format-List` cmdlet.</span></span>
...
<span data-ttu-id="59b47-119">Du kan även konvertera utdata till JSON-format.</span><span class="sxs-lookup"><span data-stu-id="59b47-119">You can also convert the output into JSON format.</span></span>  <span data-ttu-id="59b47-120">Följande exempel skapar samma lista över virtuella datorer, men ändrar formatet för utdata till JSON.</span><span class="sxs-lookup"><span data-stu-id="59b47-120">The following example creates the same list of VMs but changes the output format to JSON.</span></span>
